...
if (url.indexOf("coupon/batchGet") != -1) body = url;
...
const infoUrl =
  "https://api.m.jd.com/client.action?appid=h5_awake_wxapp&functionId=mcoupon_showcoupon&client=wh5&body=" +
...
!(async () => {
  ...
  if (batchInfo) {
      ...
      } else discountInfo = `满${quota}减${discount}`;
      ...
      $notify("京东优惠券", `${discountInfo}(${limitStr})`, couponUrl, {
          "open-url": openUrl,
      });
  }
})()
